[Currying](https://en.wikipedia.org/wiki/Currying) is the practice of writing a function that takes a function (or functions) as input, and returns a new function.
